...
Status registerOCalls() { 
   ...
   Status status;
   status = client->exit_call_provider()->RegisterExitHandler(kprintfOCallHandler, ExitHandler{printf});
   status = client->exit_call_provider()->RegisterExitHandler(kprintfOCallHandler, ExitHandler{printf});
   status = client->exit_call_provider()->RegisterExitHandler(kputsOCallHandler, ExitHandler{puts});
   status = client->exit_call_provider()->RegisterExitHandler(krandOCallHandler, ExitHandler{rand});
   status = client->exit_call_provider()->RegisterExitHandler(ksrandOCallHandler, ExitHandler{srand});
   status = client->exit_call_provider()->RegisterExitHandler(ktimeOCallHandler, ExitHandler{time});
   status = client->exit_call_provider()->RegisterExitHandler(kdraw_lineOCallHandler, ExitHandler{draw_line});
}
